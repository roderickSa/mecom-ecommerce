            ...
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                <form id="myForm" action="{{ route('update.banner', $banner->id) }}" method="post"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($banner->banner_image) ? url($banner->banner_image) : url('upload/no_image.jpg/') }}"
                                                alt="banner" style="width:100px;height:100px;" />
                                        </div>
                                    </div>
                                    <div class="row">
