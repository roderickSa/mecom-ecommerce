            ...
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('change.status.vendor') }}" method="post">
                                    @csrf
                                    @if (session('status'))
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="name" class="form-control"
                                                value="{{ $vendor->username }}" disabled />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="email" class="form-control" value="{{ $vendor->email }}"
                                                disabled />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-vendor_join">
                                            <input type="text" name="address" class="form-control"
                                                value="{{ $vendor->vendor_join }}" disabled />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="vendor_short_info" class="form-control" placeholder="Vendor Info" disabled>{{ $vendor->vendor_short_info }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            @if ($vendor->status == 'active')
                                                <input type="submit" class="btn btn-secondary px-4"
                                                    value="Change to Inactive" />
                                            @else
                                                <input type="submit" class="btn btn-success px-4"
                                                    value="Change to Active" />
                                            @endif
                                        </div>
                                    </div>
                                </form>
